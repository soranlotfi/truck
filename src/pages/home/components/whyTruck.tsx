...
const WhyTruck = ()=>{
    ...
    return(
        <Grid item container p={{xs:"2rem .5rem" , md:"2rem"}} alignItems={"center"}>
            <Grid item container rowSpacing={3} justifyContent={"center"}>
                <Grid item container justifyContent={"center"} alignItems={"center"} rowSpacing={".9rem"} padding={"1rem 0"}>
                    <Grid item xs={1} sm={3} container justifyContent={"end"} alignItems={"center"}>
                    ...
                    <Grid item xs={1} sm={3} container justifyContent={"start"} alignItems={"center"}>
                        <MDivider height={".1rem"} bgcolor={"primary.main"} varient={"fullWidth"} orientation={"horizontal"} flexItem width={"30%"}/>
                    </Grid>
                </Grid>
                <Grid item container xs={12} md={10} justifyContent={"space-evenly"} spacing={6} p={{xs:"1rem .5rem" , md:"2rem"}}>
                    {truckReasons.map((item , index)=>(
                        <Grid key={index} item container xs={6} sm={4} lg={3} justifyContent={"center"}>
